  ...
  return (
    <SafeAreaView style={styles.safe}>
      ...
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Bullet>
          <Text style={styles.strong}>Your check-ins.</Text> The emotion you tap, and when. If you’re
          signed out, these live only on your device and never leave your phone.
        </Bullet>
        <Bullet>
        ...
        <Bullet>
          <Text style={styles.strong}>SendGrid.</Text> Sends your sign-in code by email. It only
          handles your email address to deliver that one message.
        </Bullet>
        <Bullet>
